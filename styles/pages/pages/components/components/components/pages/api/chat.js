export default async function handler(req, res) {
  ...
  try {
    ...
    const finalMessages = [
      ...formattedMessages.slice(0, -1), // All previous messages except the last one (which we already added to the UI)
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        extended_thinking: true // Enable extended thinking mode
      })
    })
